...
do
	...
	function background(pl, t, d, i, ty)
		...
		TextLabel_2.TextSize = 16 -- increased title size for all elements
		...
		if d and d ~= "" then
			...
			TextLabel_1.TextSize = 12 -- slightly larger desc text
		end
	...
	function addDropdownSelect(p, p2, Multi, Callback, Value, List)
		...
		TextLabelValue_1.TextSize = 12 -- increased
		...
		TextBox_1.TextSize = 12 -- increased search text size
		...
		function itemslist:Add(text)
			...
			TextLabel_1.TextColor3 = Color3.fromRGB(255,255,255)
			TextLabel_1.TextSize = 14 -- increased item text
			TextLabel_1.TextXAlignment = Enum.TextXAlignment.Left
...
function Library:Window(p)
	...
	Close_1.Image = "https://www.roblox.com/Thumbs/Asset.ashx?width=420&height=420&assetId=99967063680607"
    ...
    ChSize_1.Image = "https://www.roblox.com/Thumbs/Asset.ashx?width=420&height=420&assetId=123447723820975"
	...
	Title_2.TextSize = 16 -- increased main window title
	...
	function Tabs:Tab(p)
		...
		Title_3.TextSize = 14 -- increased tab title
		...
		function Func:Section(p)
			...
			Section_1.TextSize = 14 -- increased section title
		...
		function Func:Slider(p)
			...
			TextBox_1.TextColor3 = Color3.fromRGB(255,255,255)
			TextBox_1.TextSize = 14 -- increased value text
		...
		function Func:Code(p)
			...
			TextLabel_1.TextColor3 = Color3.fromRGB(255,255,255)
			TextLabel_1.TextSize = 14 -- increased code title
			TextLabel_1.TextXAlignment = Enum.TextXAlignment.Left
			...
			TextButton_1.TextSize = 13 -- increased copy button text
	...
	do
        ...
        Size_1.BackgroundColor3 = Color3.fromRGB(255,255,255) -- or any color you want for the border/background
        Size_1.BackgroundTransparency = 0 -- Show background
        ...
        Size_1.Image = "https://www.roblox.com/Thumbs/Asset.ashx?width=420&height=420&assetId=116233935815807"
		...
		do
            ...
            CloseIcon.Image = "https://www.roblox.com/Thumbs/Asset.ashx?width=420&height=420&assetId=116233935815807"
